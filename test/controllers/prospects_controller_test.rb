...
class ProspectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prospect" do
    assert_difference('Prospect.count') do
      post prospects_url, params: { prospect: { age: @prospect.age, disease: @prospect.disease, familydisease: @prospect.familydisease, gender: @prospect.gender, height: @prospect.height, tobacco: @prospect.tobacco, weight: @prospect.weight, zipcode: @prospect.zipcode } }
    end
  ...
  test "should update prospect" do
    patch prospect_url(@prospect), params: { prospect: { age: @prospect.age, disease: @prospect.disease, familydisease: @prospect.familydisease, gender: @prospect.gender, height: @prospect.height, tobacco: @prospect.tobacco, weight: @prospect.weight, zipcode: @prospect.zipcode } }
